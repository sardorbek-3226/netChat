...
function NetChatLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      {/* Notification Popup */}
      {showNotification && (
        <div className="fixed bottom-4 left-4 z-50 bg-red-500 text-white p-4 rounded-lg shadow-lg max-w-xs">
          <button
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <button className="text-xs bg-white text-red-500 px-2 py-1 rounded mt-1">Fix with 🔧</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="mb-6">
                <div
                  className={`w-16 h-16 bg-gradient-to-r ${feature.color} rounded-2xl flex items-center justify-center text-white text-2xl shadow-lg mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
                  {feature.icon}
                </div>
