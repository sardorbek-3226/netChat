...
function KanbanBoard() {
  const [columns, setColumns] = useState([
    {
      ...
      tasks: [
        ...
        { id: "4", text: "Implement dashboard", completed: false },
        { id: "5", text: "Add responsive design", completed: false },
        { id: "6", text: "Write documentation", completed: false },
        { id: "7", text: "Test application", completed: false },
        { id: "8", text: "Deploy to production", completed: false },
        { id: "9", text: "Setup monitoring", completed: false },
      ],
    },
    {
      id: "inprogress",
      title: "In Progress",
      tasks: [
        { id: "10", text: "API integration", completed: false },
        { id: "11", text: "Database optimization", completed: false },
        { id: "12", text: "UI/UX improvements", completed: false },
        { id: "13", text: "Performance testing", completed: false },
        { id: "14", text: "Security audit", completed: false },
      ],
    },
    {
      id: "done",
      title: "Done",
      tasks: [
        { id: "15", text: "Project planning", completed: true },
        { id: "16", text: "Requirements gathering", completed: true },
        { id: "17", text: "Initial wireframes", completed: true },
        { id: "18", text: "Team setup", completed: true },
      ],
    },
  ])
  ...
  return (
    <div className="pt-24 min-h-screen bg-gradient-to-br from-blue-300 via-blue-400 relative overflow-x-hidden">
      <div
        className="absolute bottom-0 right-0 w-2/3 h-2/3 bg-cover bg-center bg-no-repeat opacity-80 pointer-events-none z-0"
        style={{
          ...
          {columns.map((column, columnIndex) => (
            <div
              ...
              className={`bg-white rounded-2xl shadow-lg p-6 ${
                columnIndex === 2 ? "lg:max-h-96" : "min-h-[600px]"
              } flex flex-col`}
            >
              ...
              <div className="flex-1 space-y-3 overflow-y-auto">
                {column.tasks
                  .slice(0, columnIndex === 2 ? 4 : column.tasks.length)
                  .map((task) => (
                    <div
                      key={task.id}
